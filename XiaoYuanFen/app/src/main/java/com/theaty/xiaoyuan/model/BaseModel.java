...
import com.theaty.xiaoyuan.debug.HttpUtilNew;
...
public class BaseModel implements Serializable {
	...
	public static String HOSTIP = "39.106.155.228";
	public static String bucket = "quwudao";
	...
	public HttpUtils genHttpUtils() {
		HttpUtils utils = new HttpUtilNew(8000);// 8秒超时
		utils.configCurrentHttpCacheExpiry(0);// 0秒缓存
		return utils;
	}
	public HttpUtils genHttpUtils2() {
		HttpUtils utils = new HttpUtilNew(8000);// 8秒超时
		utils.configCurrentHttpCacheExpiry(0);// 0秒缓存
		return utils;
	}
