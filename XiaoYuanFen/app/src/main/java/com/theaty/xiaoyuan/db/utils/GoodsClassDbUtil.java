...
public class GoodsClassDbUtil {
    private static final String TAG = MemberDbUtil.class.getSimpleName();
    private DaoManager mManager;
    private DaoSession mDaoSession;
    private static volatile GoodsClassDbUtil instance;

    private GoodsClassDbUtil(Context context) {
    ...
    public static GoodsClassDbUtil getInstance() {
        if (instance == null) {
            synchronized (MemberDbUtil.class) {
                if (instance == null) {

                    instance = new GoodsClassDbUtil(AppContext.getInstance());
                }
            }
        }
        return instance;
