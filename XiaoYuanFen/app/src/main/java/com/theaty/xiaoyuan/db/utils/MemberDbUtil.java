...
public class MemberDbUtil {
    ...
    private static volatile MemberDbUtil instance;

    private MemberDbUtil(Context context) {
    ...
    public static MemberDbUtil getInstance() {
        if (instance == null) {
            synchronized (MemberDbUtil.class) {
                if (instance == null) {

                    instance = new MemberDbUtil(AppContext.getInstance());
                }
            }
        }
        return instance;
