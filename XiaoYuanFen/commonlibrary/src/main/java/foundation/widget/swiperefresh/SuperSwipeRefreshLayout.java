...
//    }
    ...
    private boolean allowParentInterceptFlag = true;//是否允许父view拦截事件的标识
    //为解决SuperSwipeRefreshLayout嵌套下LoopRotarySwitchView和ViewPager的滑动冲突增加的方法

    /**
     * 是否允许父ViewGroup拦截事件
     * @param allowIntercept true:允许拦截，false:不拦截
     */
    public void setAllowParentIntercept(boolean allowIntercept){
        this.allowParentInterceptFlag = allowIntercept;
    }


    @Override
    public boolean onInterceptTouchEvent(MotionEvent ev) {
       /* if(!allowParentInterceptFlag){
            requestDisallowInterceptTouchEvent(true);//parent不拦截
            return false;
        }
*/
        ensureTarget();
