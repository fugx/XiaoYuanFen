...
public abstract class BaseActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(hasLollipopMr1()) {
            ...
            StatusBarCompat.setStatusBarColor(this,Color.GRAY);
        }
...
//		}
    ...
    protected void registerBackTitle(int resId) {
        if (_navBar == null)
            return;

        showNavigationBar(true);
        _navBar.registerBackTitle(resId, new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                goBack();
            }
    ...
    protected void registerBackTitle(String resId) {
        if (_navBar == null)
            return;
