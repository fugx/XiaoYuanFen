...
/**
 * Created by lixiangyi on 2017/9/22.
 */
...
public class FloatView extends ImageButton {
    ...
    private WindowManager.LayoutParams windowManagerParams = ((AppContext) getContext()
...
//        if (floatView == null) {
//            floatView = new FloatView(AppContext.getInstance());
//                }
//            return floatView;
//
//    }
