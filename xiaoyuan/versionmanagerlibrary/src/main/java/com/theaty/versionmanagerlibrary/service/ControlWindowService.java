...
//        throw new UnsupportedOperationException("Not yet implemented");
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if (mTimer == null) {
            mTimer = new Timer();
            mTimer.scheduleAtFixedRate(new RefreshControlWindow(), 0, 10000);
        }
        url_version = intent.getStringExtra("url");
...
//                startService(serviceIntent);
    ...
    private void addWindow(final CheckVersionBean data) {
        ...
        if (mUpdataWindow == null) {
            ...
            final WindowManager.LayoutParams layoutParams = new WindowManager.LayoutParams(WindowManager.LayoutParams.TYPE_TOAST);
