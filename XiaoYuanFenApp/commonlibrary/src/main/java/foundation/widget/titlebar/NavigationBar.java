...
public class NavigationBar extends RelativeLayout {
    ...
    protected void initWidthContext(Context context) {
        ...
        mTvLeft = (TextView) findViewById(R.id.nav_bar_back_tv);
    }
    ...
    public void registerBackTitle(int res, OnClickListener listener) {
        if (listener == null) {
            mIvBack.setVisibility(View.INVISIBLE);
    ...
    public void registerBackTitle(String  res, OnClickListener listener) {
        if (listener == null) {
            mIvBack.setVisibility(View.INVISIBLE);
            mTvLeft.setVisibility(GONE);
        } else {
